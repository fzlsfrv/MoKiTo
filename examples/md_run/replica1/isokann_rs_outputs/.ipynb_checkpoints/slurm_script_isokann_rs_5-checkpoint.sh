#!/bin/bash
#SBATCH --job-name=my_job_240f-dataloader              # Name of the job
#SBATCH --output=../isokann_rs_outputs/isokann_rs_job%j_output_240f.txt     # Standard output and error log
...
python isokann_random_search_5.py
