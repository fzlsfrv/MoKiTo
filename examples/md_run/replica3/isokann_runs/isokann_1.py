...
pt.save(f_NN.state_dict(), out_isokann  + 'f_NN_aligned_1.pt')
np.savetxt(out_isokann + 'outs/val_LOSS_aligned_1.txt', val_LOSS)
np.savetxt(out_isokann + 'outs/train_LOSS_aligned_1.txt', train_LOSS)
np.savetxt(out_isokann + 'outs/chi0_aligned_1.txt', chi)
np.savetxt(out_isokann + 'outs/convergence_aligned_1.txt', convergence)
