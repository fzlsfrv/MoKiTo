...
#pt.save(f_NN.state_dict(), out_isokann  + 'f_NN_aligned_3.pt')
np.savetxt(out_isokann + 'outs/val_LOSS_aligned_3.txt', val_LOSS)
np.savetxt(out_isokann + 'outs/train_LOSS_aligned_3.txt', train_LOSS)
np.savetxt(out_isokann + 'outs/chi0_aligned_3.txt', chi)
np.savetxt(out_isokann + 'outs/convergence_aligned_3.txt', convergence)
