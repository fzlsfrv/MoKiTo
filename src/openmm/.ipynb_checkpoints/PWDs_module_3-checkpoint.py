...
def generate_PWDistances_torch(
    ...
    pt.save(D0, iso_dir + 'PWDistances_0_40f-full.pt')
    ...
    for f in range(len(fs_folders)):
        ...
        for i in tqdm(range(0,int(Npoints//6),25)):
    ...
    pt.save(Dt, iso_dir + 'PWDistances_t_40f-full.pt')
