...
NN_nodes = [
    (Ndims, 8192, 8192, 2048, 1),
    (Ndims, int(Ndims/2), 4096, 1),
    (Ndims, int(Ndims/4), 2048, 1),
    (Ndims, int(Ndims/8), 512, 1)
]

NN_lr = np.linspace(1e-2, 1e-3, 10)        
NN_wd = np.linspace(1e-4, 1e-3, 8)         
NN_bs = np.arange(100, 300, 50)           
NN_patience = np.arange(2, 7)
NN_mu = np.linspace(0.6, 0.99, 5)
NN_epochs = np.arange(5, 10, 5)            
