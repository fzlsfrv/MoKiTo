...
traj_folders = multiple_dirs(out_trajectories1_, fetch_files=False)
DT_list = [pt.load(os.path.join(path, 'PWDistances_t_aligned.pt'), map_location='cpu') for path in traj_folders]
DT = pt.cat(DT_list, dim=1)
frame = 9
